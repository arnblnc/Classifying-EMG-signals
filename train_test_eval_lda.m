...
folder_path = 'Replace with directory to folder of data';
...
lda = fitcdiscr(trainingData, trainingLabels, "DiscrimType", "linear");
...
Mdl = fitcdiscr(trainingData, trainingLabels, "DiscrimType", "linear");
...
confusionchart(testLabels, predictedLabels, "Title", 'LDA Model', ...
...
% Log Loss
logLoss = loss(Mdl, testData, testLabels, 'LossFun', 'crossentropy');
fprintf('Log Loss: %.3f\n', logLoss);
